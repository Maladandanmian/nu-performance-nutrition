    ...
    <div className="min-h-screen" style={{background: 'linear-gradient(135deg, #86BBD8 0%, #578DB3 100%)'}}>
      ...
      <header className="bg-white/95 backdrop-blur shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          {/* Discreet Trainer Login — top-right, intentionally low-key */}
          <a
            href={getLoginUrl()}
          ...
          <Card className="bg-white/95 backdrop-blur border-none shadow-2xl ring-4 ring-white/50">
            ...
            <CardContent>
              <form onSubmit={handleEmailLogin} className="space-y-4">
                <div>
                  <Label htmlFor="email" className="text-base" style={{color: '#2B2A2C'}}>
                ...
                >
                  {loginWithEmailMutation.isPending ? "Logging in..." : "Access Dashboard"}
                </Button>
                <p className="text-xs text-center" style={{color: '#6F6E70'}}>
                  Contact your trainer if you need help accessing your account
                </p>
              </form>
            </CardContent>
          </Card>
